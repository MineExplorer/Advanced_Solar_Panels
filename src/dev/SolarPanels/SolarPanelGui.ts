function getSolarPanelGuiContent(name: string, maxOutput: number): UI.WindowContent {
	return {
		standard: {
			...
			background: {color: Color.parseColor("#353535")}
		},
		...
		drawing: [
			...
			{type: "bitmap", x: 398, y: 107, bitmap: "asp_energybar_0", scale: guiScale},
		],

		elements: {
			"energyScale": {type: "scale", x: 398 + guiScale * 4, y: 107, direction: 0, value: 0.5, bitmap: "asp_energybar_1", scale: guiScale},
			...
			"light": {type: "image", x: 426, y: 175, bitmap: "asp_dark", scale: guiScale}
		}
	}
}
